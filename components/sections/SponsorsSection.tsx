      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            DevFest Ireland 2025 is made possible by our amazing sponsors and partners
          </p>
        </div>
        ...
        <div className="mb-12">
          <div className="text-center mb-8">
            <Badge className="bg-yellow-500 text-white px-4 py-2 text-lg mb-4">Gold Sponsors</Badge>
            <p className="text-gray-600">Premier sponsors supporting DevFest Ireland</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {goldSponsors.map((sponsor) => (
              ...
              >
                <div className="w-24 h-24 bg-yellow-500 rounded-lg flex items-center justify-center mx-auto mb-4">
        ...
        <div className="mb-12">
          <div className="text-center mb-8">
            <Badge className="bg-gray-500 text-white px-4 py-2 text-lg mb-4">Silver Sponsors</Badge>
            <p className="text-gray-600">Supporting the developer community</p>
          </div>
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {silverSponsors.map((sponsor) => (
              ...
              >
                <div className="w-16 h-16 bg-gray-500 rounded-lg flex items-center justify-center mx-auto mb-3">
                  <span className="text-white font-bold text-sm">{sponsor.logo}</span>
                </div>
                <h3 className="font-semibold text-gray-900 text-sm mb-1">{sponsor.name}</h3>
        ...
        <div className="mb-12">
          <div className="text-center mb-8">
            <Badge className="bg-amber-600 text-white px-4 py-2 text-lg mb-4">Bronze Sponsors</Badge>
            ...
            {bronzeSponsors.map((sponsor) => (
              ...
              >
                <div className="w-12 h-12 bg-amber-600 rounded-lg flex items-center justify-center mx-auto mb-2">
                  <span className="text-white font-bold text-xs">{sponsor.logo}</span>
                </div>
                <h3 className="font-semibold text-gray-900 text-xs mb-1">{sponsor.name}</h3>
                <p className="text-xs text-gray-600">{sponsor.description}</p>
              </Card>
            ))}
          </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {partners.map((partner) => {
              const [bgClasses, , iconBgClass] = getPartnerColorClasses(partner.color).split(" ")
              return (
                <Card
                  key={partner.id}
                  className={`p-6 text-center hover:shadow-lg transition-shadow bg-gradient-to-br ${bgClasses}`}
                >
                  <div className={`w-16 h-16 ${iconBgClass} rounded-lg flex items-center justify-center mx-auto mb-3`}>
